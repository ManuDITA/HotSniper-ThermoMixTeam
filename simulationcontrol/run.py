...
def hotPotato_dvfs():
    threads = 4
    run(['{:.1f}GHz'.format(2.5), 'ondemand', 'mediumDVFS', 'hotPotato', 'crit_temp_80', 'rot_interval_2.5ms', 'rot_step_none', 'threshold_low', 'temp_normal'], get_instance('parsec-blackscholes', threads, input_set='simsmall'))
